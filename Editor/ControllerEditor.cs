...
public class ControllerEditor : Editor
{
		...
		{
				#if !API
				Undo.RecordObject(controller, "TradeSys Controller");
				#endif
				
				EditorGUILayout.BeginHorizontal ();
				GUILayout.FlexibleSpace ();
				if (Application.isPlaying)
						controller.selC = GUILayout.Toolbar (controller.selC, new string[] {
								"Settings",
								"Goods",
								"Manufacturing",
								"Overview",
		...
		#region settings				
			...
			#region pause options
						...
						EditorGUI.indentLevel = 0;
						EditorGUILayout.BeginHorizontal ();
						controller.pauseOption = EditorGUILayout.Popup ("", controller.pauseOption, controller.pauseOptions, "DropDownButton");
