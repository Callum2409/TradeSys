        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (sel)
            {
                ...
                case 0:
                    ...
                    #region options
                    if (GUITools.TitleGroup(new GUIContent("Options", "Set information about how the trade post works"), controllerSO.FindProperty("opTP"), false))
                    {//if showing options
                                ...
                                {//if foldout for goods group open
                                    ...
                                    {//go through all goods in stock
                                        ...
                                        if (GoodEnabled(currentStock))
                                        {
                                            ...
                                            if (customPricing.boolValue)
                                            {//if custom pricing enabled, allow price edits
                                            ...
                                            if (currentStock.FindPropertyRelative("minMax").boolValue)
                                            {//only show min max options if enabled
                                                ...
                                                if (stopProcesses.boolValue)
                                                {//if stop processes has been enabled, then add to the tooltip string
